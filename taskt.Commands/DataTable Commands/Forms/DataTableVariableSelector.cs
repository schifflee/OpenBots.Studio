...
{
    public partial class DataTableVariableSelector : ThemedForm
    {
        public DataTableVariableSelector()
        {
            InitializeComponent();
        }

        private void DataTableVariableSelector_Load(object sender, EventArgs e)
        {
        }
